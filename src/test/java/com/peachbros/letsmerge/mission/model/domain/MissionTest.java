...
class MissionTest {
    ...
    @Test
    void MissionInit() {
        assertThat(new Mission(MISSION_NAME, START_DATE_TIME, END_DATE_TIME)).isInstanceOf(Mission.class);
    }
    ...
    void isActive(LocalDateTime dateTime, boolean result) {
        Mission mission = new Mission(MISSION_NAME, START_DATE_TIME, END_DATE_TIME);
    ...
    void validateDateTime() {
        assertThatThrownBy(() -> new Mission(MISSION_NAME, END_DATE_TIME, START_DATE_TIME))
